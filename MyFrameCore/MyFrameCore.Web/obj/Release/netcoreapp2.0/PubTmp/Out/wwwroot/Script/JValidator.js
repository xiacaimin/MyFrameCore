...
//不能为空，并且不能必须小于n位数的字符串
function isLenStrAndNotNull(obj, n)
{
    var controlObj = $.trim(obj);
    if (controlObj.length == 0 || controlObj == null || controlObj == undefined) {
        return false;
        ...
        if ($(this).attr("checkexpession") != undefined) {
            switch ($(this).attr("checkexpession")) {
                ...
                case "NotNull":
                    {
                        if (isNotNull($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "不能为空！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Num":
                    {
                        if (!isInteger($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须为数字！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Email":
                    {
                        if (!isEmail($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须为E-mail格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "EnglishStr":
                    {
                        if (!isEnglishStr($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须为字符串！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "LenNum":
                    {
                        if (!isLenNum($(this).val(), $(this).attr("length"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为" + $(this).attr("length") + "位数字！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "LenStr":
                    {
                        if (!isLenStr($(this).val(), $(this).attr("length"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为" + $(this).attr("length") + "位字符！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "LenStrOrNull":
                    {
                        if (!isLenStrOrNull($(this).val(), $(this).attr("length"))) {
                            Validatemsg = $(this).attr("checkname") + "必须小于" + $(this).attr("length") + "位字符！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "LenStrAndNotNull": isLenStrAndNotNull
                    {
                        if (!isLenStrAndNotNull($(this).val(), $(this).attr("length"))) {
                            Validatemsg = $(this).attr("checkname") + "必须小于" + $(this).attr("length") + "位字符！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                ...
                case "Phone":
                    {
                        if (!isTelephone($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须电话格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Fax":
                    {
                        if (!isTelephoneOrNull($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须为传真格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Mobile":
                    {
                        if (!isMobile($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须为手机格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "MobileOrPhone":
                    {
                        if (!isMobileOrPhone($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须为电话格式或手机格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Uri":
                    {
                        if (!isUri($(this).val())) {
                            Validatemsg = $(this).attr("checkname") + "必须为网址格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Equal":
                    {
                        if (!isEqual($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "不相等！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Date":
                    {
                        if (!isDate($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为日期格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "DateTime":
                    {
                        if (!isDateTime($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为日期时间格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Time":
                    {
                        if (!isTime($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为时间格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "ChineseStr":
                    {
                        if (!isChinese($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为中文！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Zip":
                    {
                        if (!isZip($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为邮编格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "Double":
                    {
                        if (!isDouble($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为小数！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "IDCard":
                    {
                        if (!isIDCard($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为身份证格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "IsIP":
                    {
                        if (!isIP($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为IP格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
                        break;
                ...
                case "IPOrNull":
                    {
                        if (!isIPOrNullOrNull($(this).val(), $(this).attr("eqvalue"))) {
                            Validatemsg = $(this).attr("checkname") + "必须为IP格式！\n";
                            Validateflag = false;
                            ChangeCss($(this), Validatemsg); return false;
                        }
...
function ChangeCss(obj, Validatemsg) {
    ...
    //    $('.select').removeClass("tooltipselecterr");
    //}
    ...
    //}
    $(obj).focus(); //焦点
    jeBox.msg(Validatemsg, {icon:1,time:1.5});
    //$('body').append('<table id="tipTable" class="tableTip" style="display:block;"><tr><td  class="leftImage"></td> <td class="contenImage" align="left"></td> <td class="rightImage"></td></tr></table>');
    //$('#tipTable').show().css("left", $(obj).offset().left - 2 + 'px').css("top", $(obj).offset().top + 25 + 'px');
    //$('#tipTable').width($(obj).width());
